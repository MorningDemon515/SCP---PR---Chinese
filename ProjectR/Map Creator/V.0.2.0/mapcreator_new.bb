...
WinHandle=CreateWindow("SCP-CB: PR - Map Creator "+versionnumber,GraphicsWidth()/2-ResWidth/2, GraphicsHeight()/2-ResHeight/2,ResWidth,ResHeight,0, 13) 
...
InitEvents("..\ProjectR\Data\events.ini")
AddEvents() ; PXLSHN.
