...
Function InitItemTemplates()
	...
	CreateItemTemplate("SCP-427","scp427","GFX\items\427.b3d","ProjectR\GFX\items\INV427.jpg", "", 0.001)
	...
	;Project Resurrection (Not all of the contents originated from the original mods. Rather, we made it.)
	;Box Of Horrors (SCPs, Documents, Others)
	it = CreateItemTemplate("SCP-005", "scp005", "ProjectR\GFX\items\untitled2.b3d", "ProjectR\GFX\items\INV005.jpg", "", 0.0004,"ProjectR\GFX\items\keyB_tx.jpg")	
	it = CreateItemTemplate("SCP-178", "scp178", "ProjectR\GFX\items\scp178.b3d", "ProjectR\GFX\items\INV178.jpg", "", 0.02,"","",1)
	
	it = CreateItemTemplate("Note from Maynard", "paper", "GFX\items\note.x", "GFX\items\INVnote.jpg", "ProjectR\GFX\items\maynard005note.png", 0.0025, "GFX\items\notetexture.jpg") : it\sound = 0	
	it = CreateItemTemplate("Document SCP-005", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc005.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-009", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc009.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-038", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc038.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-409", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc409.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-1074", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc1074.jpg", 0.003) : it\sound = 0	
	it = CreateItemTemplate("SCP-1074 Containment Notice", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc_arce.jpg", 0.003) : it\sound = 0

	it = CreateItemTemplate("Document Unknown", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc1074_Joke.jpg", 0.003) : it\sound = 0

	it = CreateItemTemplate("Binoculars", "binocular", "ProjectR\GFX\items\binoculars.b3d", "ProjectR\GFX\items\INVbinoculars.jpg", "", 0.03) : it\sound = 2
					
	it = CreateItemTemplate("Pill", "clonedpill", "GFX\items\pill.b3d","GFX\items\INVpill.jpg","",0.0001) : it\sound = 2
	EntityColor it\obj,255,0,0
		
	it = CreateItemTemplate("Green Jade Ring", "ring", "GFX\items\scp714.b3d", "GFX\items\INV714.jpg", "", 0.3) : it\sound = 3
	...
	it = CreateItemTemplate("Key","misc","ProjectR\GFX\items\untitled2.b3d", "ProjectR\GFX\items\INV005.jpg", "", 0.0004,"ProjectR\GFX\items\keyB_tx.jpg")
	it = CreateItemTemplate("3-D Glasses", "glasses", "ProjectR\GFX\items\scp178.b3d", "ProjectR\GFX\items\INV178.jpg", "", 0.02,"","",1)	
	it = CreateItemTemplate("Soviet GP-5 Gas Mask","mask","GFX\items\SCP-1499.b3d","GFX\items\INVscp1499.jpg", "", 0.023,"GFX\items\SCP-1499.jpg") : it\sound = 2
	it = CreateItemTemplate("Carved Locket","locket","GFX\items\427.b3d","ProjectR\GFX\items\INV427.jpg", "", 0.001)
	
	;Fan Breach (SCPs (New models), Documents, Others)
	it = CreateItemTemplate("SCP-001", "scp001", "ProjectR\GFX\items\scp001.x", "ProjectR\GFX\items\INV001.jpg", "", 0.003) : it\sound = 0
	it = CreateItemTemplate("SCP-1079", "scp1079", "ProjectR\GFX\items\scp1079_packet.b3d","ProjectR\GFX\items\INV1079P.jpg","",0.18) : it\sound = 2						
	it = CreateItemTemplate("SCP-1079-01", "scp1079sweet", "ProjectR\GFX\items\scp1079.b3d", "ProjectR\GFX\items\INV1079.jpg", "", 0.01, "ProjectR\GFX\items\candy2.jpg") : it\sound = 2

	it = CreateItemTemplate("SCP-001 Report", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc001.jpg", 0.003) : it\sound = 0	
	it = CreateItemTemplate("Document SCP-006", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc006.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-113", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc113.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-650", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "ProjectR\GFX\items\doc650.jpg", 0.003) : it\sound = 0			
	
	;Project Resurrection (SCPs, Documents, Others)

	it = CreateItemTemplate("Bloody Note", "paper", "GFX\items\paper.x", "ProjectR\GFX\items\INVbloodnote.jpg", "ProjectR\GFX\items\Passcode\Passcode0.jpg", 0.003, "ProjectR\GFX\items\bloodynotetex.jpg") : it\sound = 0									
	it = CreateItemTemplate("Note To Doctor Harp", "paper", "GFX\items\paper.x", "GFX\items\INVnote.jpg", "ProjectR\GFX\items\docrosen2.jpg", 0.003) : it\sound = 0
...
Function UpdateItems()
	...
	If ClosestItem <> Null Then
		...
		;If MouseHit1 And Then PickItem(ClosestItem)
	EndIf
			...
			If Inventory(n) = Null Then
				Select item\itemtemplate\tempname
					Case "1123"
						If Not (Wearing714 = 1) Then
							If PlayerRoom\RoomTemplate\Name <> "room1123" Then
								...
								DeathMSG = "D-9341在试图袭击九尾狐的一名成员后被枪杀.监控录像显示."
								DeathMSG = DeathMSG + "大约9分钟前在现场徘徊,大喊 " + Chr(34) + "除四害" + Chr(34)
								DeathMSG = DeathMSG + " 用中文. SCP-1123在[REDACTED]被发现, 暗示与它发生了身体接触 "
								DeathMSG = DeathMSG + "SCP-1123究竟如何突破收容的,目前还不清楚."
								Kill()
							EndIf
					...
					Case "killbat"
						...
						DeathMSG = "D-9341被发现死在SCP-914的输出室里,旁边似乎是一块普通的九伏电池. "
						DeathMSG = DeathMSG + "电烧伤,并被认为是通过电池引起的电击而死亡的.蓄电池已储存以供进一步研究."
						Kill()
					Case "scp148"
