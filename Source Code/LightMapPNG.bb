...
Color 255,255,255
Text 5,5,"请按一个按键:"
Text 5,25,"1 - 将BMP转换为PNG,并修改rmesh以使用它们"
Text 5,45,"2 - 将特定房间的BMP转换为PNG,并对其进行修改以使用它们"
Text 5,65,"3 - 还原options.ini以使用旧的rmesh"
Text 5,85,"ESC - 关闭"
Flip
