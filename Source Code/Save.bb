...
Function SaveGame(file$)
    ...
    ;BoH/PR
	WriteFloat f, crystalization
	WriteFloat f, BubbleFoam

	WriteByte f, BriefcaseOn
	WriteByte f, Juan 
	WriteByte f, Condition113
	WriteByte f, Repeat113
	WriteByte f, Limit1079
	WriteByte f, Take1079
	WriteByte f, BubbleTrigger
...
Function LoadGame(file$)
    ...
    ;BoH
	crystalization = ReadFloat(f)
	BubbleFoam = ReadFloat(f)
	
	BriefcaseOn = ReadByte(f)
	Juan = ReadByte(f)
	Condition113 = ReadByte(f)
	Repeat113 = ReadByte(f)
	Limit1079 = ReadByte(f)
	Take1079 = ReadByte(f)
	BubbleTrigger = ReadByte(f)
	...
	For i = 1 To temp
		...
		Select NPCtype
			Case NPCtypeOldMan, NPCtypeD, NPCtype096, NPCtypeMTF, NPCtypeGuard, NPCtype049, NPCtypeZombie, NPCtypeClerk, NPCtype650
